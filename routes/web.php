...
Route::get('/admin/upload-form', [AdminController::class, 'showUploadForm']);
Route::post('/admin/upload-form', [AdminController::class, 'uploadForm']);

Route::get('/admin/map-fields/enrollment_form', [AdminController::class, 'showMapFields'])->name('admin.map-fields');
Route::post('/admin/save-mapping', [AdminController::class, 'saveMapping']);
